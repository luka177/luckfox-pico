...
export RK_PARTITION_CMD_IN_ENV="15K@17K(env),512K@32K(idblock),256K@544K(uboot),32M@817K(boot),512M(oem),256M(userdata),1G(rootfs),256M(ohd_config),256M(swap),-(RECORDINGS)"
